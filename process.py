...
#THIS IS THE IMPORTANT DATA REUSLTS
            ...
            #Co_ordExcel(Num_words_section,total_words,total_time_seconds)
            ...
            with open('raw.csv', 'a', newline='\n') as f:
                writer = csv.writer(f)
                writer.writerow([total_time_seconds,Num_words_section])

                f.close()

            x_new = (total_time_seconds - df[0][0])

            print(' X NEW ' + str(x_new))
            y_new = Num_words_section
            print(' Y NEW ' + str(y_new))

            Wpm = y_new/(x_new/60)
            print("-------")
            print(Wpm)

            # /Users/abdiwaliabdi/PycharmProjects/untitled3/data/examples/

            with open('run_log.csv', 'a', newline='\n') as f:
                writer = csv.writer(f)
                writer.writerow([total_time_seconds,Wpm])
...
def main():
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        ...
        #NEED TO MAKE CODE TO STORE THE VALUE INTO THE DATABASE
